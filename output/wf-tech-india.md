...
B.Tech CSE student at Manipal University Jaipur, Expected 2028. Builds and tests backend systems — authentication, distributed rate limiting, and payment verification.

# EDUCATION
**Manipal University Jaipur** | Jaipur, Rajasthan
B.Tech in Computer Science and Engineering | Expected 2028 | CGPA: 8.16/10
Coursework/certifications: NPTEL Algorithms (IIT Madras, 2026), DSA in Java (IIT Kharagpur, 2025), SQL (Oracle Academy, 2025), Red Hat System Administration I & II (2026)

# EXPERIENCE
**Freelance Full-Stack Developer | Redline Garage | 2026**
*TanStack Start, TypeScript, PostgreSQL (Supabase), Razorpay*
- Built a retailer-commissioned e-commerce platform with a PostgreSQL product/order schema covering catalog, cart, checkout, and order tracking.
...
- Deployed via Docker/Nginx multi-instance setup on Terraform-provisioned Azure VMs behind a load balancer with shared Redis; covered with 13 Jest tests, CI concurrency checks, and k6 load testing.
...
- Built a full-stack platform that converts study material into accessible formats for users with different access needs, with a modular conversion pipeline and keyboard-accessible UI.
- Audited with axe-core, fixed 2 detected violations (1 critical), and reached 0 accessibility violations across all application routes.

# LEADERSHIP
Operations Team, Oneiros 2025, Manipal University Jaipur — coordinated on-ground logistics and day-of scheduling for the university annual fest across multiple event days.

# SKILLS
**Languages & Frameworks:** Java, Python, JavaScript, TypeScript, SQL, Node.js, Express.js, React, Next.js
**Data:** PyTorch, PostgreSQL, MongoDB, Redis, Supabase
...
---
Suggested export filename: `Atreya_Mitra_WellsFargo_TechIntern_2027.pdf`
